...
InstrDesc opcodes_fd[256] = {
    ...
    /* 0x32 */  {"LD (%s),A", ABS16, true},
    /* 0x33 */  {"???", NONE, true},
    /* 0x34 */  {"INC (IY%s)", ABS8, false},
    /* 0x35 */  {"DEC (IY%s)", ABS8, false},
    /* 0x36 */  {"LD (IY+%s #$37", ABS16, false},
    /* 0x37 */  {"???", NONE, true},
    /* 0x38 */  {"JR C, %s", REL, true},
    /* 0x39 */  {"???", NONE, false},
    /* 0x3a */  {"LD A, (%s)", ABS16, true},
    ...
    /* 0x6c */  {"???", NONE, true},
    /* 0x6d */  {"???", NONE, true},
    /* 0x6e */  {"LD L, (IY%s)", ABS8, false},
    /* 0x6f */  {"???", NONE, true},
    /* 0x70 */  {"LD (IY%s), B", ABS8, false},
    /* 0x71 */  {"LD (IY%s), C", ABS8, false},
    /* 0x72 */  {"LD (IY%s), D", ABS8, false},
    /* 0x73 */  {"LD (IY%s), E", ABS8, false},
    /* 0x74 */  {"LD (IY%s), H", ABS8, false},
    /* 0x75 */  {"LD (IY%s), L", ABS8, false},
    /* 0x76 */  {"???", NONE, true},
    /* 0x77 */  {"LD (IY%s), A", ABS8, false},
    /* 0x78 */  {"???", NONE, true},
    /* 0x79 */  {"???", NONE, true},
    /* 0x7a */  {"???", NONE, true},
    /* 0x7b */  {"???", NONE, true},
