...
std::vector<Disassembler::Line> Disassembler::disassembleBackward(std::uint16_t pos, const std::vector<std::uint8_t>& memory, int lines) {
    std::vector<Line> res;
...
Disassembler::Line Disassembler::disassembleLine(std::uint16_t& pos, const std::vector<std::uint8_t>& memory) {
    Line res;
    res.addr = pos;
